...
# inherit variables and methods from PluginInterface as well
class Godmode(PluginInterface):
	...
	This is all you need to write. Here is an example for the packet type `PlayerHit`

	def onPlayerHit(self, client: Client, packet: Packet, send: bool) -> (PlayerHit, bool):
